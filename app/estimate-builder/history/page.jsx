  ...
  return (
    <div className="max-w-5xl mx-auto p-6 md:p-10 animate-fade-in-up">
      <div className="flex justify-between items-end mb-8">
        ...
        <Link href="/estimate-builder/create" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-semibold shadow transition-colors">
          + New Estimate
        </Link>
      </div>
      ...
      {estimates.length === 0 ? (
        <div className="bg-white border border-dashed border-gray-300 rounded-2xl p-16 text-center">
          <svg className="w-16 h-16 text-gray-300 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 13h6m-3-3v6m-9 1V7a2 2 0 012-2h6l2 2h6a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2z" /></svg>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {estimates.map((est) => (
            <div key={est._id} className="bg-white border border-gray-200 p-6 rounded-2xl shadow-sm hover:shadow-md transition-shadow relative group">
              
              <div className="flex justify-between items-start mb-4">
                <div className="w-10 h-10 bg-blue-50 text-blue-600 rounded-lg flex items-center justify-center font-bold text-xl">
                  {est.nameOfWork.charAt(0).toUpperCase()}
                </div>
                <button
              ...
              <h2 className="font-bold text-xl text-gray-900 mb-1 line-clamp-1" title={est.nameOfWork}>{est.nameOfWork}</h2>
